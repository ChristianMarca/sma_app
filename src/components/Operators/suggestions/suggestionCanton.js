...
import { requestAddressAction, interruptionCantonAction, interruptionProvinceAction } from '../../../actions';
import {
...
function renderSuggestion(suggestion) {
	return (
		<div className="renderBox">
			{suggestion.canton}~{suggestion.provincia}
		</div>
	);
}
...
function mapDispatchToProps(dispatch) {
	return {
		...
		async onSuggestionsFetchRequestedMerge(value, interruptionLevel, interruptionTechnologies, id_usuario) {
			await dispatch(
				requestAddressAction(value, 'canton', interruptionLevel, interruptionTechnologies, id_usuario)
			);
