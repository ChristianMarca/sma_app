...
import { requestAddressAction, interruptionProvinceAction } from '../../../actions';
import {
...
function renderSuggestion(suggestion) {
	return <div className="renderBox">{suggestion.provincia}</div>;
}
...
function mapDispatchToProps(dispatch) {
	return {
		...
		async onSuggestionsFetchRequestedMerge(value, interruptionLevel, interruptionTechnologies, id_usuario) {
			await dispatch(
				requestAddressAction(value, 'provincia', interruptionLevel, interruptionTechnologies, id_usuario)
			);
