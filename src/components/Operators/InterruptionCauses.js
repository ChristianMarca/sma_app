			...
			<div className="addressContainer card-body">
				<div className="servicesContainer">
					...
					<div className="service">
						...
						/>
						<label className="services" htmlFor="voz">
							VOZ
						</label>
						<input
							className="radioButton"
							...
							onChange={this.toggleCheckboxServices}
						/>
						<label className="services" htmlFor="sms">
							SMS
						</label>
						<input
							className="radioButton"
							...
							onChange={this.toggleCheckboxServices}
						/>
						<label className="services" htmlFor="datos">
							DATOS
						</label>
					</div>
				</div>
				...
				<div className="servicesContainer">
					...
					<div className="service">
						...
						/>
						<label className="services" htmlFor="gsm">
							GSM
						</label>
						<input
							className="radioButton"
							...
							onChange={this.toggleCheckboxTechnologies}
						/>
						<label className="services" htmlFor="umts">
							UMTS
						</label>
						<input
							className="radioButton"
							...
							onChange={this.toggleCheckboxTechnologies}
						/>
						<label className="services" htmlFor="lte">
							LTE
						</label>
					</div>
				</div>
				...
				<div className="searchContainer">
					<div className="textarea-containerCauses">
						<textarea
							...
							type="text"
							size="1"
							onChange={this.regexA}
							required
						/>
						<div className="textarea-size" />
					</div>
					<p className="textField" id="resultado" />
				</div>
			</div>
		);
	}
