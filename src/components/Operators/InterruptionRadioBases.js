...
class InterruptionAddress extends React.Component {
	...
	handleAddRadioBase = () => {
		...
		if (this.props.interruptionTechnologies.length) {
			...
			const location = {
				provincia: interruptionProvince,
				canton: interruptionCanton,
				parroquia: interruptionParish
			};
	...
	render() {
		...
		if (this.props.interruptionLevel === 'PARROQUIA') {
			parroquia = [
				<h6 key="titleProvincia" className="titleInput">
					Provincia
				</h6>,
				<SuggestionProvince key="suggestProvincia" isLockField={true} />,
				<h6 key="titleCanton" className="titleInput">
					Canton
				</h6>,
				<SuggestionCanton key="suggestCanton" isLockField={true} />,
				<h6 key="titleParroquia" className="titleInput">
					Parroquia
				</h6>,
		...
		if (this.props.interruptionLevel === 'CANTON') {
			parroquia = [
				...
				<SuggestionProvince key="suggestProvincia" isLockField={true} />,
				<h6 key="suggestCanton" className="titleInput">
					Canton
				</h6>,
			...
			<div className="addressContainer card-body">
				<div className="servicesContainer">
					<div className="cardChild">
						<header>
							<div className="subTitleCard">Codigo de Estación</div>
						</header>
						<div className="cardContent">
							...
							<div className="ContainerCodEst">
								...
								<button
									type="button"
									className="buttonSubmitAddForCodEst"
									onClick={this.addCodEstUnique}
								>
									&#x271A;
								</button>
							</div>
					...
					<div className="cardChild">
						...
						<div className="cardContent">
							<div className="ContainerAddButton">
								...
								<button
									onClick={this.handleAddRadioBase}
									className="buttonSubmitAddForCodEst addButton"
								>
									&#x271A;
								</button>
							</div>
							<div className="interruptionLevelContainer">
								...
								/>
								<label className="interruptionLevel" htmlFor="provincia">
									Provincia
								</label>
								<input
									className="radioButton"
								...
								<input
									...
									onChange={this.onInterruptionLevelChange}
								/>
								<label className="interruptionLevel" htmlFor="parroquia">
									Parroquia
								</label>
							</div>
							{/* <span>
